...
public class JSONStorage {
 private final File file;
    ...
    public JSONStorage(String filePath) { this.file = new File(filePath); }
    ...
    public void saveMessages(ArrayList<Message> messages) throws IOException {
        ...
        for (int i = 0; i < messages.size(); i++) {
            ...
            sb.append("{\"messageID\":").append(m.getMessageID())
              .append(",\"messageNumber\":").append(m.getMessageNumber())
              .append(",\"recipient\":\"").append(escape(m.getRecipient()))
              .append("\",\"content\":\"").append(escape(m.getContent()))
              .append("\",\"messageHash\":\"").append(escape(m.getMessageHash()))
              .append("\"}");
